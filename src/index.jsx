...
const { App } = await dc.require(dc.resolvePath("REVERSE FLIGHT/src/App.jsx"));
...
const RootView = (props) => {
  ...
  useEffect(() => {
    ...
    styleEl.id = "reverse-flight-immersive";
    ...
    const interval = setInterval(async () => {
      try {
        const cmdFile = dc.resolvePath("REVERSE FLIGHT/data/mcp_commands.json");
    ...
    return () => {
      ...
      const existing = document.getElementById("reverse-flight-immersive");
