    ...
    function SafeRoot() {
        ...
        dc.useEffect(function () {
            ...
            if (!styleEl) {
                ...
                styleEl.id = STYLE_ID;
                styleEl.innerHTML = `
                    /* REVERSE FLIGHT: Hide global status bar and view footers for immersive full-tab layout */
        ...
        if (!appComponent) {
            return (
                <div style={{ padding: "40px", background: "var(--background-primary)", color: "var(--text-muted)", fontFamily: "monospace" }}>
                    Initializing Reverse Flight Workspace...
                </div>
            );
        }
